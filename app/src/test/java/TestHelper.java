...
/**
 * Created by patrickengelkes on 07/02/15.
 */
public class TestHelper {

    public static void checkAlertDialog(String dialogTitle) {
        AlertDialog alert = ShadowAlertDialog.getLatestAlertDialog();
        ShadowAlertDialog shadowAlertDialog = Robolectric.shadowOf(alert);
